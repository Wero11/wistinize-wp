...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'slug'               => 'fastwp-shortcodes-v1.0', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/fastwp/plugins/fastwp-shortcodes-v1.0.zip', // The plugin source.
